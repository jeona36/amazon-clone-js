...
//it also has a method called .format() it help us to write the date in an easy format. this method takes a string which tells what kind of format we want for the date. in the documentation there is a table that shows us special charactars that we can put in the string.
      ...
      <div class="cart-item-details-grid">
        ...
        <div class="cart-item-details">
          ...
          <div class="product-quantity">
            ...
            js-save-link link-primary" data-product-id="${matchingProduct.id}">Save</span>
